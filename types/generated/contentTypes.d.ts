...
export interface ApiContentCreatorContentCreator
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creator_type: Schema.Attribute.Enumeration<
      ['internal_staff', 'guest_contributor', 'partner_organization']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'internal_staff'>;
    email: Schema.Attribute.Email;
    ...
    premium_contents: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiInstructorInstructor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    training_partner: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiPedagogyTypePedagogyType
  extends Struct.CollectionTypeSchema {
  collectionName: 'pedagogy_types';
  info: {
    displayName: 'Pedagogy Type';
    pluralName: 'pedagogy-types';
    singularName: 'pedagogy-type';
  };
  options: {
    draftAndPublish: false;
    timestamps: true;
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedagogy-type.pedagogy-type'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    training_modules: Schema.Attribute.Relation<
      'oneToMany',
      'api::training-module.training-module'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPremiumCategoryPremiumCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'premium_categories';
  info: {
    displayName: 'Premium Category';
    pluralName: 'premium-categories';
    singularName: 'premium-category';
  };
  options: {
    draftAndPublish: false;
    timestamps: true;
...
export interface ApiPremiumContentPremiumContent
  ...
  attributes: {
    ...
    gallery: Schema.Attribute.Component<'shared.media-gallery', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::premium-content.premium-content'
    >;
    premium_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::premium-category.premium-category'
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    seo_metadata: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    tag_type: Schema.Attribute.Enumeration<
      ['topic', 'skill', 'region', 'heritage_type']
    > &
      Schema.Attribute.Required;
    training_tracks: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiTrainingCategoryTrainingCategory
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    research_lineage: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    what_it_covers: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTrainingModuleTrainingModule
  extends Struct.CollectionTypeSchema {
  collectionName: 'training_modules';
  info: {
    displayName: 'Training Module';
    pluralName: 'training-modules';
    singularName: 'training-module';
  };
  options: {
    draftAndPublish: true;
    timestamps: true;
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    pedagogy_type: Schema.Attribute.Relation<
      'manyToOne',
      'api::pedagogy-type.pedagogy-type'
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    training_sessions: Schema.Attribute.Relation<
      ...
      'api::training-session.training-session'
    >;
    training_track: Schema.Attribute.Relation<
      'manyToOne',
      'api::training-track.training-track'
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiTrainingPartnerTrainingPartner
  extends Struct.CollectionTypeSchema {
  collectionName: 'training_partners';
  info: {
    displayName: 'Training Partner';
    pluralName: 'training-partners';
    singularName: 'training-partner';
  };
  options: {
    draftAndPublish: false;
    timestamps: true;
  ...
  attributes: {
    ...
    organization_type: Schema.Attribute.Enumeration<
      ['university', 'polytechnic', 'ngo', 'government', 'private']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'organization_name'>;
    training_tracks: Schema.Attribute.Relation<
      'oneToMany',
      'api::training-track.training-track'
    >;
...
export interface ApiTrainingSessionTrainingSession
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::training-session.training-session'
    >;
    materials: Schema.Attribute.Component<'shared.attachment', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    session_type: Schema.Attribute.Enumeration<
      ['lecture', 'workshop', 'practice', 'assessment']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    training_module: Schema.Attribute.Relation<
      'manyToOne',
      'api::training-module.training-module'
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiTrainingTrackTrainingTrack
  extends Struct.CollectionTypeSchema {
  collectionName: 'training_tracks';
  info: {
    displayName: 'Training Track';
    pluralName: 'training-tracks';
    singularName: 'training-track';
  };
  options: {
    draftAndPublish: true;
    timestamps: true;
  ...
  attributes: {
    applicable_launchpad_tracks: Schema.Attribute.Enumeration<
      ['cultural_experience', 'service', 'product', 'health_activity']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    certificate_available: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    learning_objectives: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    recommended_onboarding_stage: Schema.Attribute.Enumeration<
      ['pre_certification', 'post_certification', 'tier_progression', 'anytime']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    required_certification_tier: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    strapi_course_id: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    training_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::training-category.training-category'
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vendor_prep_required: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiVendorVendor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    business_type: Schema.Attribute.Enumeration<
      ['individual', 'cooperative', 'sme', 'enterprise']
    > &
      Schema.Attribute.Required;
    ...
    logo: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'business_name'>;
    training_status: Schema.Attribute.Enumeration<
      ['pending', 'in_progress', 'certified']
    > &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pedagogy-type.pedagogy-type': ApiPedagogyTypePedagogyType;
      'api::premium-category.premium-category': ApiPremiumCategoryPremiumCategory;
      ...
      'api::training-module.training-module': ApiTrainingModuleTrainingModule;
      'api::training-partner.training-partner': ApiTrainingPartnerTrainingPartner;
      'api::training-session.training-session': ApiTrainingSessionTrainingSession;
      'api::training-track.training-track': ApiTrainingTrackTrainingTrack;
